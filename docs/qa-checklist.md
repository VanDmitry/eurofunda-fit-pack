...
- [ ] Указан только подтверждённый диапазон `Tramo principal: 180–370 cm`.
- [ ] Для chaise longue нет спорного точного диапазона; вместо него предлагается проверка совместимости по фото.
